...
public class AddmoneyBiller {
	
WebDriver driver;
	
	public AddmoneyBiller(WebDriver driver) 
	{						//constructor
	...
	public void Addbiller(String number1,String number2) throws InterruptedException
	{
	...
	public void Scroll() throws InterruptedException
	{
		...
		yes.click();
		Thread.sleep(3000);
		System.out.println("Money Added to Biller:" +success.getText());
		Thread.sleep(5000);
	}
