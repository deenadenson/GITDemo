...
public class Banner_Merchant {

	
WebDriver driver;
	
	public Banner_Merchant(WebDriver driver) 
	{						//constructor
	...
	@FindBy(xpath="//div[contains(text(),'Datapack')]")
	WebElement feature;
	...
	public void Banner_mer() throws InterruptedException
	{
		Thread.sleep(3000);
		banner1.click();
		banner2.click();
	...
	public void Upload(String data1,String data2) throws InterruptedException
	{
		...
		confirm.click();
		Thread.sleep(3000);
		System.out.println("Banner Uploaded to Merchant:" +success.getText());
