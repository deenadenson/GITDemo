...
public class WithdrawBiller {
	
WebDriver driver;
	
	public WithdrawBiller(WebDriver driver) 
	{						//constructor
	...
	public void Withdrawbill(String number1,String number2) throws InterruptedException
	{
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOf(service1)).click();
		service1.click();
		withdraw1.click();
		c11.click();
		c21.click();
	...
	public void Scroll() throws InterruptedException
	{
		...
		yes.click();
		Thread.sleep(3000);
		System.out.println("Money Withdraw from Biller:" +success.getText());
	}
